...
JWT_PRIVATE_KEY = os.getenv("JWT_PRIVATE_KEY", "insecure-dev-key-change-me")
...
# ---------------------------------------------------------------------------
# Documentation Authentication (Basic Auth for browser prompt)
# ---------------------------------------------------------------------------
import secrets
...
DOCS_PASSWORD = os.getenv("DOCS_PASSWORD", "supersecretpassword")
