...
from routers import cameras, analytics, auth_routes
...
async def lifespan(app: FastAPI):
    # Startup: ensure PostGIS extension + tables exist.
    # In production, replace create_all_tables() with Alembic migrations.
    try:
        init_postgis()
        create_all_tables()
        logger.info("Database ready: PostGIS extension confirmed, tables ensured.")
