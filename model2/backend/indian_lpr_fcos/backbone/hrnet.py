...
class HighResolutionNet(nn.Module):
    def __init__(self, **kwargs):
        ...
        # NOTE(integration): original was `np.int(...)` — np.int was removed
        # in numpy>=1.24 and this would raise AttributeError on model
        # construction. last_inp_channels isn't referenced elsewhere in this
        # file (dead code even upstream), so a plain int() keeps behavior
        # identical while fixing the crash.
